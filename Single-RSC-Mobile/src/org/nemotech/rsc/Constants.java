...
public class Constants {
    ...
    public static final String VERSION = "2.5.0 Mobile";
    ...
    public static final String APPLICATION_TITLE = "RSC Mobile " + VERSION;

    public static int APPLICATION_WIDTH = 512, APPLICATION_HEIGHT = 334;
    
    public static final boolean APPLICATION_RESIZABLE = false;
    
    /**
     * On Android, CACHE_DIRECTORY is the asset-relative prefix (empty string).
     * On desktop, it was the absolute path to cache/.
     * All file loading goes through Util.openFile() which handles the platform difference.
     */
    public static String CACHE_DIRECTORY = "";

    /**
     * Directory for persistent player saves.
     * On Android, this is the app's internal files directory (set at runtime).
     */
