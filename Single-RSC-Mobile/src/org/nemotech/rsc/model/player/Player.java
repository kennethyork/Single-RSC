...
public final class Player extends Mob {
    ...
    public void load(String username) {
        ...
        try {
            ...
            new java.io.File(Constants.SAVE_DIRECTORY + "players").mkdirs();

            String fileUser = this.username.toLowerCase(java.util.Locale.ROOT);

            // load player cache file
            java.io.File cacheFile =
                resolvePlayerFile(Constants.SAVE_DIRECTORY, fileUser + "_cache.dat");
        ...
        try {
            ...
            java.io.File dataFile =
                resolvePlayerFile(Constants.SAVE_DIRECTORY, fileUser + "_data.dat");
        ...
        preferredDimension = new int[]{ playerData.applicationWidth, playerData.applicationHeight };
    ...
    public void save() {
        ...
        try {
            ...
            String fileUser = this.username.toLowerCase(java.util.Locale.ROOT);
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(Constants.SAVE_DIRECTORY + "players/" + fileUser + "_cache.dat"));
        ...
        try {
            ...
            String fileUser = this.username.toLowerCase(java.util.Locale.ROOT);
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(Constants.SAVE_DIRECTORY + "players/" + fileUser + "_data.dat"));
    ...
    public void killedBy(Mob mob) {
        ...
        if (isHardcore()) {
            ...
            throw new RuntimeException("Hardcore death - game over");
        }
